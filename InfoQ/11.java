<html><head><meta http-equiv="content-type" content="text/html; charset=utf-8" /></head><body><h3>Improving Process with Two Definitions of Done</h3><p>Christian Vos, founder of <a href="http://www.roodmitek.nl/">Rood Mitek</a> and Microsoft .NET consultant at <a href="https://www.rabobank.com/en/group/About_Rabobank_group/Profile/organisation/Rabobank_International.html">Rabobank International</a>, proposed separate ideal and current versions of Definition of Done for agile teams in his recent <a href="http://www.scrumalliance.org/community/articles/2014/january/why-using-a-definition-of-done-in-an-agile-project">blog</a>, in order to expand Definition of Done to grow in maturity and quality. Vos cites competence and maturity of the team as reasons why a team would use two versions.</p>
...
<p>Vos stated because of less maturity and competence of agile teams, Definition of Done doesn’t include all the steps necessary to deliver production ready code. Typically when finishing a sprint, different items are still left undone. The problem with this undone work is that it piles up every sprint and many teams solve this undone work by introducing extra sprint dedicated for release preparation.</p>
<blockquote> 
...
<p>David Lowe, agile coach at <a href="http://www.net-a-porter.com/">Net-A-Porter</a>, supports the idea of having two versions of Definition of Done.</p>
<blockquote> 
...
<p>On similar lines Wouter Tengeler, owner of <a href="http://www.themotionstudio.nl/en/">The Motion Studio Multimedia Productions</a> suggests creation of separate user stories.</p>
<blockquote> 
...
<p>Dave Meyer, product marketing specialist at <a href="https://www.atlassian.com/">Atlassian</a> explained how to use Jira, for managing Definition of Done over the period of time, in his recent <a href="https://blogs.atlassian.com/2013/10/8-steps-to-a-definition-of-done-in-jira/">blog</a>.</p>
<blockquote> 
