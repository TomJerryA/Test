<html>
 ...
 <body> 
  ...
  <div> 
   <a href="https://raw.github.com/TomJerryA/Test/master/InfoQ/8.java">Reactions to Yahoo!’s Decision to Forbid Employee Telecommuting</a>Yahoo!’s recent decision to call all employees to work from company’s offices has raised some questions especially throughout the telecommuting community. Is this a disguised move to lay off people? Is it a misunderstanding of how remoting is to be managed? Is this the right move for Yahoo!? 
  </div> 
  <div> 
   <a href="https://raw.github.com/TomJerryA/Test/master/InfoQ/7.java">Eclipse RAP 2.0 Released - Same Acronym, Different Name</a>On January 11th, Eclipse RAP 2.0 was released, after 6 years of development. InfoQ talked to the project lead about the release. 
  </div> 
  <div> 
   <a href="https://raw.github.com/TomJerryA/Test/master/InfoQ/6.java">How Swarming Helps Agile Teams to Deliver</a>Swarming is a technique that helps agile teams to deliver working software fast and frequently. What is swarming, what are the benefits of swarming, and when and how to apply it? 
  </div> 
  <div> 
   <a href="https://raw.github.com/TomJerryA/Test/master/InfoQ/5.java">Vagrant Support for Amazon AWS</a>HashiCorp's latest addition to support Amazon AWS as provider for Vagrant Virtual Machines (VM) is in a new league: for the first time it will be possible to spin up Virtual Machines in the cloud instead of the developer's desktop. 
  </div> 
  <div> 
